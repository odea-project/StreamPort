...
class MassSpecDataMethodExtractFeaturesNative(ProcessingMethod):
    ...
    Details:
        The method extracts features from ms data using seasonal decomposition and FFT, adding entries named "features" and "features_raw" to each dict in the data list of the MassSpecAnalyses instance.
        The "features" include:
            - area: The area under the chromatogram peak.
            - runtime: The runtime of the analysis.
            - residual_mean: The mean of the residuals from seasonal decomposition.
            - residual_std: The standard deviation of the residuals from seasonal decomposition.
            - residual_sum: The sum of the residuals from seasonal decomposition.
